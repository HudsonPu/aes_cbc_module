...
***************************
insmod aes_cbc_module.ko encrypt=1 key="000102030405060708090a0b0c0d0e0f"
***************************
*/
  unsigned char in[] = {
  ...
  n_write = write(pt_fd, &in, sizeof(in));
  n_read = read(ct_fd, &buffer, sizeof(buffer));
